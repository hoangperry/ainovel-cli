...
// gen_models.go kéo toàn bộ model từ OpenRouter API, sinh baseline compile-time models_generated.go.
// Cách dùng: go generate ./internal/models/...
package main
...
const (
	...
	// maxModelAgeDays quyết định baseline giữ lại model cũ tới mức nào. Quá tuổi này coi như đã lỗi thời (GPT-3.5,
	// GPT-4 bản gốc, Llama 2, Mistral 7b v.v.), loại bỏ thẳng để giảm kích thước binary và nhiễu khi truy vấn.
	// Giữ nhất quán với bộ lọc runtime của pricing.go.
	maxModelAgeDays = 730
)

// Giữ nhất quán với pricing.go.
...
// isTooOld xác định timestamp created có vượt maxModelAgeDays không.

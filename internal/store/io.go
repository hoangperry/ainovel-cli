...
// IO bao bọc các thao tác đọc/ghi hệ thống tập tin, cung cấp khóa và ghi nguyên tử.
// Mỗi sub-store giữ một instance IO độc lập, sở hữu sync.RWMutex riêng.
type IO struct {
	dir string
	mu  sync.RWMutex
}
...
// EnsureDirs tạo các thư mục con chỉ định.

...
func renderHelpText(width int) string {
	...
	b.WriteString(titleStyle.Render(i18n.T("ui.command.help.title")))
	b.WriteString("\n\n")
	...
	b.WriteString("\n")
	b.WriteString(titleStyle.Render(i18n.T("ui.command.help.shortcuts")))
	b.WriteString("\n\n")
	for _, line := range []string{
		i18n.T("ui.command.help.key.slash"),
		i18n.T("ui.command.help.key.updown"),
		i18n.T("ui.command.help.key.tab"),
		i18n.T("ui.command.help.key.esc"),
		i18n.T("ui.command.help.key.ctrlr"),
	} {
...
func renderHelpModal(width, height int, state *helpState) string {
	...
	modal := renderPaddedModalFrame(
		boxW,
		boxH,
		i18n.T("ui.command.help.title"),
		i18n.T("ui.command.help.modal_hint"),
